...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/getting-started/quickstart">
    Get up and running with Byron in under 10 minutes.
  </Card>

  <Card title="Supported Documents" icon="file-lines" href="/features/supported-documents">
    See every tax form Byron can process.
  </Card>
