...
description: "Byron is an AI tax document platform that extracts, validates, and exports data from W-2s, 1099s, K-1s, and more into Lacerte, CCH Axcess, and GoSystem."
---
